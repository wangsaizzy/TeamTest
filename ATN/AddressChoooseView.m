...
#import "AddressCommon.h"
#import "UIViewExt.h"



#define TitleHeight 40.f
@interface AddressChoooseView ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
@end
@implementation AddressChoooseView
    ...
    if (_pickerView) {
        ...
        if (self.ActionDistrictViewSelectBlock) {
            self.ActionDistrictViewSelectBlock(areaTitle,@{Key_DistrictSelectProvince:provinceName,
                                                           ...
                                                           Key_DistrictSelectCityCode:cityName,
